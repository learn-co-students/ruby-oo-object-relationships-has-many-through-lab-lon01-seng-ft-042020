...
describe 'Patient' do
  ...
  describe '#new_appointment' do
    it 'given a doctor and date, creates a new appointment belonging to that patient' do
      ...
      appointment = hevydevy.new_appointment(doctor_who, 'Friday, January 22nd')
  ...
  describe '#appointments' do
    it 'returns all appointments associated with this Patient' do
      ...
      appointment = Appointment.new('Friday, January 22nd', steve, doctor_who)
      appointment_2 = Appointment.new('Saturday, January 23rd', steve, doctor_smith)
      appointment_3 = Appointment.new('Sunday, January 24th', mike, doctor_who)
  ...
  describe '#doctors' do
    it 'has many doctors through appointments' do
      ...
      hevydevy = Patient.new('Devin Townsend')
      hevydevy.new_appointment(doctor_who, 'Friday, January 22nd')
      hevydevy.new_appointment(doctor_what, 'Saturday, January 23rd')
